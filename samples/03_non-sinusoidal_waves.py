...
for waveName, waveFunc in waves:
    ...
    fig.suptitle(f'Plot of {waveName} Y(x) and the Magnitude of its Discrete Fourier Transform |U(f)|')
    ...
    fig.suptitle(f'Plot of {waveName} Generated By Applying IFFT to U(f)')
    axis.plot(xRange, yRange, 'tab:orange')
    axis.plot(xRange, yInvRange, 'tab:blue')
    axis.set(xlabel = "x", ylabel = "Obtained Y(x)")
    plt.show()
